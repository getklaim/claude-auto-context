...
3. Read `CLAUDE.md`
4. Check minimum threshold: at least 2 rules files (committed + local combined)
...
6. For each issue found, create a suggestion file in `.claude-auto-context/suggestions/` using the standard format:
   - Filename: `YYYYMMDD-HHMMSS-hygiene-{slug}.md` (timestamp-based naming)
